...
Design-agent contract: [../deliverables/DESIGN_BRIEF.md](../deliverables/DESIGN_BRIEF.md) + [../deliverables/ASSET_MANIFEST.md](../deliverables/ASSET_MANIFEST.md).
...
- [`Desk Show — Embodied Agent Podcast.md`](<../../Desk Show — Embodied Agent Podcast.md>) — 2 Sep 2026: HostMind as the live brain, face UI + TTS as the body; fal off the live path.
- [grokbots.html](../mocks/grokbots.html) — Mouthless two-host face mock (Broderick / ROAM steal: pill eyes, squash talk, no lip sync).
