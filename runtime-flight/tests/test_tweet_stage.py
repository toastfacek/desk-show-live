...
assert.strictEqual(shotFallbackPath("solo_r"), "/tweet-shot-split.png");
assert.strictEqual(shotFallbackPath("card_full"), "/tweet-shot-split.png");
assert.strictEqual(shotFallbackPath("split"), "/tweet-shot-split.png");
